<%-- 
    Document   : Jobseeker-Forgot Password1
    Created on : Mar 18, 2014, 3:33:15 PM
    Author     : Hitzyy
--%>
...
<html>
<head>
<title>Jobseeker-Forgot Password</title>
...
<div id="text3" style="position:absolute; overflow:hidden; left:275px; top:137px; width:339px; height:28px; z-index:8">
<div class="wpmd">
<div><font color="#FF9900" face="Arial Narrow" class="ws16">SecureJob Jobseeker - Forgot Password</font></div>
<div><font color="#808080" face="Tahoma" class="ws8"><BR></font></div>
</div></div>

<input name="formtext1" type="text" style="position:absolute;width:210px;left:357px;top:208px;z-index:9">
<div id="text1" style="position:absolute; overflow:hidden; left:273px; top:211px; width:80px; height:19px; z-index:10">
<div class="wpmd">
<div><font color="#333333"><B>Username</B></font></div>
</div></div>

<input name="submit" type="submit" value="Submit" style="position:absolute;left:356px;top:249px;z-index:11">
<div id="hr1" style="position:absolute; overflow:hidden; left:17px; top:410px; width:764px; height:17px; z-index:12">
<hr size=2 width=764>
</div>

<div id="text5" style="position:absolute; overflow:hidden; left:264px; top:440px; width:223px; height:119px; z-index:13; background-color:#F7F7F7">
<div class="wpmd">
...
<div id="text6" style="position:absolute; overflow:hidden; left:517px; top:433px; width:223px; height:119px; z-index:14; background-color:#F7F7F7">
<div class="wpmd">
...
<div id="flash1" style="position:absolute; overflow:hidden; left:18px; top:136px; width:227px; height:255px; z-index:15">
...
<div id="text7" style="position:absolute; overflow:hidden; left:274px; top:173px; width:208px; height:25px; z-index:16">
<div class="wpmd">
<div><font face="Tahoma">Please enter your username</font></div>
</div></div>
