<%-- 
    Document   : Agent-MyProfile
    Created on : Mar 18, 2014, 3:41:56 PM
    Author     : Hitzyy
--%>
...
<div id="g_image1" style="position:absolute; overflow:hidden; left:21px; top:1px; width:584px; height:8px; z-index:6"><img src="images/busi2_line.jpg" alt="" title="" border=0 width=584 height=8></div>

<div id="text1" style="position:absolute; overflow:hidden; left:19px; top:441px; width:223px; height:119px; z-index:7; background-color:#F7F7F7">
<div class="wpmd">
...
<div id="image2" style="position:absolute; overflow:hidden; left:770px; top:0px; width:20px; height:620px; z-index:8"><img src="images/ver_line.gif" alt="" title="" border=0 width=20 height=620></div>

<div id="hr1" style="position:absolute; overflow:hidden; left:17px; top:410px; width:764px; height:17px; z-index:9">
<hr size=2 width=764>
</div>

<div id="text6" style="position:absolute; overflow:hidden; left:264px; top:440px; width:223px; height:119px; z-index:10; background-color:#F7F7F7">
<div class="wpmd">
...
<div id="text8" style="position:absolute; overflow:hidden; left:517px; top:433px; width:223px; height:119px; z-index:11; background-color:#F7F7F7">
<div class="wpmd">
...
<div id="text13" style="position:absolute; overflow:hidden; left:3px; top:243px; width:123px; height:28px; z-index:15">
<div class="wpmd">
<UL>
